...
```{r save}
sf::st_write(bg,"data/census_blockgroup_newark.geojson")
sf::st_write(tr,"data/census_tract_newark.geojson")
sf::st_write(newark,"data/service_area_newark.geojson")
```
