...
st_write(alt_polygons,"finalData/alt_polygons.geojson")
st_write(bg_polygons,"finaldata/bg_polygons.geojson")
...
st_write(newark,"finaldata/overall_polygon.geojson")
```
...
write.csv(c,"finalData/correlations.csv")
