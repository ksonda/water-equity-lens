...
```{r intersect}
alt_name = "district" #here we set the name of the alternate geometry
...
First, we create a vector of the indicator variables that are in the [data dictionary](data/WEL data dictionary_r2.xlsx), and then create an empty data frame encompassing all polygons and these variables, iterated over years of choice.dsfsdfdsfdsf
