...
pillars$indicator_bucket <- sample(c("High","Medium","Low"),length(pillars$geo_id),replace=TRUE)

#wewaf
qe <- pillars %>% 
  group_by(geo_type,var,year)%>%
  summarise(delta_quartile=gtools::quantcut(delta_percent,q=4,na.rm=TRUE))  
